...
| 문서 | 경로 | 비고 |
|------|------|------|
| **페르소나 가이드** | `/home/peterchung/WBHubManager/packages/ai-agent-core/docs/personas/reno.md` | 참조용 |
| **Internal YAML** | `personas/reno-internal.yaml` | ⚠️ 직접 수정 금지 |
| **External YAML** | `personas/reno-external.yaml` | ⚠️ 직접 수정 금지 |
...
**주요 변경 사항**:
- ✅ **페르소나 DB 관리 필수화** - YAML 직접 수정 금지, `/api/ai-admin/personas/*` API 사용
- ✅ **슬랙 포맷팅 규칙 추가** - 마크다운 금지, `[제목]` 대괄호 형식 사용
